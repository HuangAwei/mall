...
import com.hw.mall.member.service.WmsWareInfoService;
...
public class WmsWareInfoController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("member:wmswareinfo:list")
    ...
    //@RequiresPermissions("member:wmswareinfo:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("member:wmswareinfo:save")
    ...
    //@RequiresPermissions("member:wmswareinfo:update")
    ...
    //@RequiresPermissions("member:wmswareinfo:delete")
